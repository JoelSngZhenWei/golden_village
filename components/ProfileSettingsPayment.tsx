      ...
      <div className="mb-6">
        <div className="relative group">
          ...
          >
                  ...
                  <CardContent className="px-0 h-full">
                    <div className="flex flex-col justify-between gap-5 h-full">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground mt-1 h-4">{method.description || "\u00A0"}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* View all payment methods card */}
            <div>
              <Link href="">
                <Card className="border border-muted-foreground w-[165px] h-[165px] rounded-xl p-5 hover:bg-secondary/10 transition-colors">
                  <CardContent className="px-0 h-full">
                    <div className="flex flex-col justify-center items-center h-full gap-3">
                      <div className="rounded-full bg-secondary p-2">
                        <ChevronRight className="h-5 w-5" />
                      </div>
                      <span className="text-sm font-medium text-center">View all payment methods</span>
                    </div>
                  </CardContent>
                </Card>
              </Link>
