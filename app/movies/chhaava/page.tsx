...
const movie = {
  ...
  link: "chhaava",
  trailerUrl:
    "https://www.youtube.com/embed/77vRyWNqZjM?si=M5ZUFpKvvqnT1wlb&autoplay=1&muted=1&controls=0&showinfo=0&modestbranding=1&rel=0&fs=1&iv_load_policy=3&disablekb=1",
  cinema_timings: [
    {
      cinema: "GV Bishan",
